...
zh="BackCompat",Ah="ERROR: timeline named '",Bh="Error in ",Ch="False",Dh="GET",Eh="GHIJKLMNOPQRSTUVWXYZ",Fh="JESS_element",Gh="JESS_element ",Hh="JESS_element JESS_scene",Ih="JESS_element JESS_scene ",Jh="JESS_element Jess_scene ",Kh="JESS_element_container",Lh="JESS_persistent_symbols",Mh="JESS_scene",Nh="JESS_scene_index",Oh="HYP_a",Ph="HYP_b",Qh="HYP_c",Rh="HYP_d",Sh="HYP_e",Th="HYP_f",Uh="HYP_g",Vh="HYP_h",Wh="HYP_i",Xh="HYP_j",Yh="HYP_k",Zh="HYP_l",$h="HYP_m",ai="HYP_n",bi="HYP_o",ci="HYP_q",
di="HYP_t",ei="HYP_u",fi="HYP_v",gi="HYP_w",hi="JessDocumentLoad",ii="JessLayoutRequest",ji="JessResourceLoad",ki="JessSceneLoad",li="JessScenePrepareForDisplay",mi="JessSceneUnload",ni="JessSwipe",oi="JessSymbolLoad",pi="JessSymbolUnload",qi="JessTimelineAction",ri="JessTimelineComplete",si="JessTriggerCustomBehavior",ti="L ",ui="M",vi="MSPointerUp",wi="MouseEvents",xi="MozBoxShadow",yi="N",zi="O",Ai="P",Bi="Q",Ci="R",Di="S",Ei="SpriteSheet",Fi="SpriteSheetGroup",Gi="T",Hi="True",Ii="U",Ji="V",Ki=
...
Ni="_blank",Oi="_jess_grad",Pi="_jess_pat",Qi="_path",Ri="a",Si="aA",Ti="aB",Ui="aC",Vi="aD",Wi="aE",Xi="aI",Yi="aJ",Zi="aK",$i="aL",aj="aM",bj="aN",cj="aS",dj="aT",ej="aU",fj="aV",gj="aW",hj="aX",ij="aY",jj="aZ",kj="abort",lj="absolute",mj="acC",nj="alt",oj="aria-busy",pj="aria-hidden",qj="arraybuffer",rj="audio",Mk="audio/ogg",Nk="auto",Ok="autoplay",Pk="autostart",Qk="b",Rk="bA",Sk="bB",Tk="bC",Uk="bF",Vk="bG",Wk="bH",Xk="bI",Yk="bJ",Zk="bK",$k="bL",al="bM",bl="bN",cl="bO",dl="bP",el="bQ",fl="bR",
...
Tm="file://",Um="fill",Vm="fill-rule",Wm="filter",Xm="flat",Ym="font-",Zm="function",$m="g",an="gW",bn="gg",cn="gradientTransform",dn="hauptzeitachse",en="head",fn="height",gn="hidden",hn="href",jn='href="" x="0" y="0" width="1" height="1" preserveAspectRatio="xMidYMid slice" />',kn="http://",ln="hue-rotate(",mn="jess-obj-",nn="jess-scene-",on="iPad",pn="iPhone",qn="iPod",rn="ibooksimg://",sn="iframe",tn="image",un="image-rendering",vn="img",wn="img_",xn="inherit",yn="inset ",zn="j",An="kTimelineDefaultIdentifier",
...
n(a,lp),e=n(a,mp);b==k||(c==k||b==d&&c==e)||Eg(a,b,c)}function yj(a){var b=n(a,sm),c=n(a,tm),d=n(a,lp),e=n(a,mp);b==k||(c==k||b==d&&c==e)||Eg(a,b,c)}function wj(a,b,c){var d=M[a.id],e=n(a,bm)!=k,f=B.Vertices.fromPath(b);if(f==k||2>f[V])return v.JESS_DEBUG_PHYSICS==h&&console.log(Nm+a.id+$c+b),k;e==p&&B.Vertices.isConvex(f)==p&&(f=B.Vertices.hull(f));var g=B.Vertices.centre(f),j=n(a,ym,p),l=k;B.JessPlugin&&B.JessPlugin.fromVerticesWithFallback?(g=B.JessPlugin.fromVerticesWithFallback(g.x,g.y,f,{elementId:a.id},
p,0.1,10,1,e,c,j),l=g.physicsBody,g=g.centerPoint):l=B.Bodies.fromVertices(g.x,g.y,f,{elementId:a.id},p,0.1,10,1);if(l==k)return v.JESS_DEBUG_PHYSICS==h&&console.log(Om+a.id),k;l.render.path=b;b=gf(a);b=zj(b);b=rd(b,[g.x,g.y]);g=nb(d,h);d=ob(d,h);g=b[0]/g;d=b[1]/d;n(a,sm)==k&&W(a,sm,n(a,lp,0.5));n(a,tm)==k&&W(a,tm,n(a,mp,0.5));W(a,qm,g);W(a,rm,d);Eg(a,g,d);W(a,pm,n(a,Qm,0));return l}function Aj(a,b,c){var d=n(a,gl,0);if(Lc!=h||0==d||36==d)return{x:b,y:c};var e=M[a.id],f=le(e),g=hf(f),j=Gg(f),l=hf(e),
...
h)return a=of(w[Ub](a)),a==k?nf(k):nf(a.id);a=M[a];var b=Ta(ka(a));return A[b].v[a].bZ-90}function mf(a){if((a==J||a==k)==h)return A[U].bY;if(Mg(a)==h)return a=of(w[Ub](a)),a==k?mf(k):mf(a.id);a=M[a];var b=Ta(ka(a));return A[b].v[a].bY}function Ng(a){if(Kg(a)==k){var b={};Ea[z](b);a==k&&(a=J);b.identifier=a;b.Pa={};b.zc={};b.ib=[];b.Wb=0;b.Va=0;var c=B.Engine[Ia]({vc:h});b.oa=c;if(v.JESS_DEBUG_PHYSICS==h){var d={element:w[Ub](a),engine:c},d=B.Render[Ia](d);b.Xb=d}var d=mf(a),e=nf(a);a=lf(a);c.world.gravity.x=
...
b){return E(a[b],a[b+1])}function Qj(a,b,c){var d=a.x+-1*c*q.cos(b);a=a.y+-1*c*q.sin(b);return E(d,a)}function pf(a,b){return a.x==b.x&&a.y==b.y}function Ma(a){return E(a.x,a.y)}function E(a,b){return{x:a,y:b}}function Rj(a,b,c){oe!=k&&(a={element:a,triggerOnce:p,elementOffset:0},a[c]=function(){b()},c=new oe.jessS(a),rf[z](c))}function ja(a,b){return function(c){for(var d=0;d<b[V];d++){var e=b[d],f=e.p;if(1==f)wd(Sj(e.e,e.f),e.g,e.d);else if(3==f)e.b!=k&&(f=e.z!=aa?e.z:p,Hb(e.b,a!=k?a.id:k,f));else if(7==
...
a.Kb,b);Ce(a.ma?wp:Sn,a.Jb,b);a.ma?Ce(vp,a.qa,b):Ce(Qn,a.qa,b);a[wc].ka==Dm&&(Be=p);a.lb==h&&If--;fa==h&&a[wc]&&mc(a[wc].za)}}function Lf(a,b){b[wc].gc==h&&(a.jessGesturePhase=b.Ka,a.jessGestureXPosition=b.Sa[0].end.x,a.jessGestureYPosition=b.Sa[0].end.y,b.Lb(a))}function Ce(a,b,c){var d=Fb(c);d!=k&&(c=d);c[Hc]?c[Hc](a,b,p):c[Pa]&&c[Pa](ko+a,b)}function Va(a,b,c,d){var e=Fb(c);e!=k&&(c=e);e={eventType:a,handler:b,element:c};d&&Mf[z](e);c[$a]?c[$a](a,b,F.Gb?{passive:p}:p):c[Sb]&&c[Sb](ko+a,b);Xj(c)}
...
b.Ba=h;b.Cb=f.response;a!=k&&a(b);b.Za==h&&b[tb]()};f.onerror=function(){b.Na=p;d!=k&&d(b)};try{f.send()}catch(g){}}};qa(b,function(){b.Mb();var a=v.JESS_gac_660;a==k&&(a=new (v.AudioContext||v.webkitAudioContext),v.JESS_gac_660=a);a.resume!=k&&a.resume();b.source=a.createBufferSource();b[zc].connect(a.destination);ra(b[zc],b.loop);b[wc].Fb==h&&b.tb();b.Ba!=h?(b.Za=h,b.load()):b.Cb!=k?(a.decodeAudioData(b.Cb,function(a){b.ec=a;b[zc].buffer=a;b[wc].Fb!=h&&b.tb()}),b.Cb=k):(b[zc].buffer=b.ec,b[wc].Fb!=
...
rb={},db={},Cd={},pc={},ba={},yf=p,Hd={},Zb=[],mh=p,$={},eh={},Ae=[],Jd={},ve=k,Af=k,Yb={},M={},vh={},Kk=0,Df=p,Mf=[],$g={},Bd={},Fk=p,Lc=p,kf=p,Zg=p,se=[],Mc={},Hf={},qh={d:[[0,0,0.42,0,1,1,1,1]],e:[[0,0,0,0,0.58,1,1,1]],c:[[0,0,0.42,0,0.58,1,1,1]]},Id=p,rh=p,oe=v.JESS_w_660,rf=[],sh=p;ca.xb=Tf;ca.wa=Re;ca.ob=Bo;var Be=p,If=0,Jf=p,ze=[];ca.z_o=function(){0==Kk&&(Kk=uh());df!=k&&df(h,S);ef=ef&&F.xa!=k;F.Ma!=k&&w[xb][$a](xp,aq(),F.Gb?{passive:p}:p);Yb[J]=J;M[J]=J;vh[J]=J;for(var a=0;a<A[V];a++){var b=
...
R.bM=mc;R.bU=ff;R.bV=ff;R.cT=ff;R.bW=ff;R.dZ=nc;ca.API={kSceneTransitionInstant:Kf,kSceneTransitionCrossfade:2,kSceneTransitionSwap:3,kSceneTransitionPushLeftToRight:4,kSceneTransitionPushRightToLeft:5,kSceneTransitionPushBottomToTop:6,kSceneTransitionPushTopToBottom:7,kPhysicsBodyTypeDead:0,kPhysicsBodyTypeStatic:1,kPhysicsBodyTypeDynamic:2,kJessGesturePhaseStart:Xo,kJessGesturePhaseMove:Tn,kJessGesturePhaseEnd:Km,kJessGesturePhaseCancel:Tl,documentName:function(){return P},documentId:function(){return J},
